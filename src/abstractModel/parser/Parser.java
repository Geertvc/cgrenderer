...
public final class Parser extends DefaultHandler
{
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        try
        {
            ...
            else if (qName.equals("Plane"))
            {
                ...
                // call handler
                if (echoHandler != null) echoHandler.startPlane(size, name);
                if (    handler != null) handler.startPlane(size, name);
            }
            // Cube element
            else if (qName.equals("Cube"))
            {
                ...
                // call handler
                if (echoHandler != null) echoHandler.startCube(size, name);
                if (    handler != null) handler.startCube(size, name);
            }
            // Sphere element
            ...
            else if (qName.equals("Venus"))
            {
                ...
                // call handler
                if (echoHandler != null) echoHandler.startVenus(size, name);
                if (    handler != null) handler.startVenus(size, name);
            }
            // Cube element
            else if (qName.equals("Triceratops"))
            {
            	// parse size attribute
                String sizeString = attributes.getValue("size");
                if (sizeString == null) throw new ParseException("Element \"" + qName + "\" requires attribute \"size\".");
                ...
                // call handler
                if (echoHandler != null) echoHandler.startTriceratops(size, name);
                if (    handler != null) handler.startTriceratops(size, name);
            }
            // Cube element
            else if (qName.equals("Table"))
            {
                ...
                // call handler
                if (echoHandler != null) echoHandler.startTable(size, name);
                if (    handler != null) handler.startTable(size, name);
            }
            // Cube element
            else if (qName.equals("Tablecloth"))
            {
            	// parse size attribute
                String sizeString = attributes.getValue("size");
                if (sizeString == null) throw new ParseException("Element \"" + qName + "\" requires attribute \"size\".");
                ...
                // call handler
                if (echoHandler != null) echoHandler.startTablecloth(size, name);
                if (    handler != null) handler.startTablecloth(size, name);
            }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException
    {
        try
        {
            ...
            {
                // call handler
                if (echoHandler != null) echoHandler.endPlane();
                if (    handler != null) handler.endPlane();
            }
            // Cube element
            else if (qName.equals("Cube"))
            {
                // call handler
                if (echoHandler != null) echoHandler.endCube();
                if (    handler != null) handler.endCube();
            }
            // Sphere element
            else if (qName.equals("Sphere"))
            {
            ...
            {
                // call handler
                if (echoHandler != null) echoHandler.endVenus();
                if (    handler != null) handler.endVenus();
            }
            // Cube element
            else if (qName.equals("Triceratops"))
            {
                // call handler
                if (echoHandler != null) echoHandler.endTriceratops();
                if (    handler != null) handler.endTriceratops();
            }
            // Cube element
            else if (qName.equals("Table"))
            {
                // call handler
                if (echoHandler != null) echoHandler.endTable();
                if (    handler != null) handler.endTable();
            }
            // Cube element
            else if (qName.equals("Tablecloth"))
            {
                // call handler
                if (echoHandler != null) echoHandler.endTablecloth();
                if (    handler != null) handler.endTablecloth();
            }
            // IndexedTriangleSet element
            else if (qName.equals("IndexedTriangleSet"))
            {
